...
create_clock -name debugPipelineClk -period 300MHz [get_ports clk]
create_clock -name pipelineClk -period 300MHz [get_ports clock]
create_clock -name computeClk -period 600MHz [get_ports clock2x]
