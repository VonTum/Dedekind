...
wire[39:0] sum1; wire[4:0] count1; pipeline24Pack p1(clk, top, botABCDE, botIndex, isBotValid, fullWires[0], almostFullWires[0], sum1, count1);
wire[39:0] sum2; wire[4:0] count2; pipeline24Pack p2(clk, top, botBACDE, botIndex, isBotValid, fullWires[1], almostFullWires[1], sum2, count2);
wire[39:0] sum3; wire[4:0] count3; pipeline24Pack p3(clk, top, botCBADE, botIndex, isBotValid, fullWires[2], almostFullWires[2], sum3, count3);
wire[39:0] sum4; wire[4:0] count4; pipeline24Pack p4(clk, top, botDBCAE, botIndex, isBotValid, fullWires[3], almostFullWires[3], sum4, count4);
wire[39:0] sum5; wire[4:0] count5; pipeline24Pack p5(clk, top, botEBCDA, botIndex, isBotValid, fullWires[4], almostFullWires[4], sum5, count5);
